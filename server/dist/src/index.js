...
app.use(cors());
const BUNGIE_API_KEY = process.env.BUNGIE_API_KEY || "65cb0ca42ffd4995808cf1c74cd1aeb8";
const BUNGIE_MANIFEST_API_ENDPOINT = process.env.BUNGIE_MANIFEST_API_ENDPOINT ||
    "https://www.bungie.net/Platform/Destiny2/Manifest";
const DB_FILE_NAME = process.env.DB_FILE_NAME || "./src/database/manifest_db.sqlite3";
